...
contract TetherUSD is ERC20, ERC20Bridgeable, ERC20Burnable, ERC1363, ERC20Permit, ERC20FlashMint {
        ...
        ERC20Permit("Tether USD")
    {
        ...
        if (block.chainid == 229) {
            ...
            // USDT price ~$1.00, so mint 500M tokens with 6 decimals
            _mint(recipient, 500000000 * 10 ** 6); // 500M USDT (6 decimals)
        }
    }
